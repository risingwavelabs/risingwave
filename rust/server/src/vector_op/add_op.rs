...
/// Checked_add two `PrimitiveArray` for integers. Both array must have the same size.
...
/// Checked_add two `PrimitiveArray` for floats. Both array must have the same size.
