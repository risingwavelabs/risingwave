...
//     let lhs = expr_build_from_proto(
//       function_call_node
//         .get_children()
//         .get(0)
//         .ok_or_else(|| InternalError("conjunction expression must have lhs".to_string()))?,
//     )?;
//     match proto.get_expr_type() {
//       ExprNode_ExprNodeType::AND => {
//         let rhs = expr_build_from_proto(
//           function_call_node
//             .get_children()
//             .get(1)
//             .ok_or_else(|| InternalError("AND expression must have rhs".to_string()))?,
//         )?;
//         Ok(Self {
//           return_type,
...
//             .get_children()
//             .get(1)
//             .ok_or_else(|| InternalError("OR expression must have rhs".to_string()))?,
//         )?;
//         Ok(Self {
//           return_type,
...
//     }
//   }
//   fn create_cmp_expression(idx1: i32, idx2: i32, kind: ExprNode_ExprNodeType) -> Result<ExprNode> {
