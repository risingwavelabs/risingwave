...
impl Expression for CompareExpression {
    ...
    fn eval(&mut self, input: &DataChunk) -> Result<ArrayRef> {
        ...
        match self.kind {
            CompareOperatorKind::Equal => vec_eq(lhs, rhs),
            CompareOperatorKind::NotEqual => vec_neq(lhs, rhs),
            CompareOperatorKind::GreaterThan => vec_gt(lhs, rhs),
            CompareOperatorKind::GreaterThanOrEqual => vec_geq(lhs, rhs),
            CompareOperatorKind::LessThan => vec_lt(lhs, rhs),
            CompareOperatorKind::LessThanOrEqual => vec_leq(lhs, rhs),
        }
    }
}
