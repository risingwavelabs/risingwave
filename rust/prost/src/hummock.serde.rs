...
impl serde::Serialize for BlockMeta {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hummock.BlockMeta", len)?;
        if !self.smallest_key.is_empty() {
            struct_ser.serialize_field("smallestKey", pbjson::private::base64::encode(&self.smallest_key).as_str())?;
        }
        if self.offset != 0 {
            struct_ser.serialize_field("offset", &self.offset)?;
        }
        if self.len != 0 {
            struct_ser.serialize_field("len", &self.len)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for BlockMeta {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "smallestKey" => Ok(GeneratedField::SmallestKey),
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hummock.BlockMeta")
            }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::SmallestKey => {
                            if smallest_key.is_some() {
                                return Err(serde::de::Error::duplicate_field("smallestKey"));
                            }
                            smallest_key = Some(
        ...
        deserializer.deserialize_struct("hummock.BlockMeta", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Checksum {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hummock.Checksum", len)?;
        if self.algo != 0 {
            let v = checksum::Algorithm::from_i32(self.algo)
                .ok_or_else(|| serde::ser::Error::custom(format!("Invalid variant {}", self.algo)))?;
            struct_ser.serialize_field("algo", &v)?;
        }
        if self.sum != 0 {
            struct_ser.serialize_field("sum", ToString::to_string(&self.sum).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Checksum {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hummock.Checksum")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<Checksum, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut algo = None;
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::Algo => {
                            ...
                            algo = Some(map.next_value::<checksum::Algorithm>()? as i32);
                        }
                        GeneratedField::Sum => {
                            if sum.is_some() {
        ...
        deserializer.deserialize_struct("hummock.Checksum", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for checksum::Algorithm {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        let variant = match self {
            Self::Crc32c => "CRC32C",
            Self::XxHash64 => "XX_HASH64",
        };
        serializer.serialize_str(variant)
    }
}
impl<'de> serde::Deserialize<'de> for checksum::Algorithm {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                ...
                i32::try_from(v)
                    .ok()
                    .and_then(checksum::Algorithm::from_i32)
                    .ok_or_else(|| {
            ...
            {
                match value {
                    "CRC32C" => Ok(checksum::Algorithm::Crc32c),
                    "XX_HASH64" => Ok(checksum::Algorithm::XxHash64),
...
impl serde::Serialize for ReportCompactionTasksRequest {
        ...
        S: serde::Serializer,
    {
        ...
        if self.task_result {
            struct_ser.serialize_field("taskResult", &self.task_result)?;
        }
        struct_ser.end()
    }
}
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "compactTask" => Ok(GeneratedField::CompactTask),
                            "taskResult" => Ok(GeneratedField::TaskResult),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::TaskResult => {
                            if task_result.is_some() {
                                return Err(serde::de::Error::duplicate_field("taskResult"));
                            }
                            task_result = Some(map.next_value()?);
                        }
                    }
                }
                Ok(ReportCompactionTasksRequest {
                    compact_task,
                    task_result: task_result.unwrap_or_default(),
                })
            }
        }
...
impl serde::Serialize for SstableMeta {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("hummock.SstableMeta", len)?;
        if !self.block_metas.is_empty() {
            struct_ser.serialize_field("blockMetas", &self.block_metas)?;
        }
        if !self.bloom_filter.is_empty() {
            struct_ser.serialize_field("bloomFilter", pbjson::private::base64::encode(&self.bloom_filter).as_str())?;
        }
        if self.estimated_size != 0 {
            struct_ser.serialize_field("estimatedSize", &self.estimated_size)?;
        }
        if self.key_count != 0 {
            struct_ser.serialize_field("keyCount", &self.key_count)?;
        }
        if !self.smallest_key.is_empty() {
            struct_ser.serialize_field("smallestKey", pbjson::private::base64::encode(&self.smallest_key).as_str())?;
        }
        if !self.largest_key.is_empty() {
            struct_ser.serialize_field("largestKey", pbjson::private::base64::encode(&self.largest_key).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for SstableMeta {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "blockMetas" => Ok(GeneratedField::BlockMetas),
                            "bloomFilter" => Ok(GeneratedField::BloomFilter),
                            "estimatedSize" => Ok(GeneratedField::EstimatedSize),
                            "keyCount" => Ok(GeneratedField::KeyCount),
                            "smallestKey" => Ok(GeneratedField::SmallestKey),
                            "largestKey" => Ok(GeneratedField::LargestKey),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SstableMeta;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct hummock.SstableMeta")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<SstableMeta, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut block_metas = None;
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::BlockMetas => {
                            if block_metas.is_some() {
                                return Err(serde::de::Error::duplicate_field("blockMetas"));
                            }
                            block_metas = Some(map.next_value()?);
                        }
                        GeneratedField::BloomFilter => {
                            if bloom_filter.is_some() {
                                return Err(serde::de::Error::duplicate_field("bloomFilter"));
                            }
                            bloom_filter = Some(
                                map.next_value::<::pbjson::private::BytesDeserialize<_>>()?.0
                            );
                        ...
                        GeneratedField::KeyCount => {
                            if key_count.is_some() {
                                return Err(serde::de::Error::duplicate_field("keyCount"));
                            }
                            key_count = Some(
                                map.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0
                            );
                        ...
                        GeneratedField::LargestKey => {
                            if largest_key.is_some() {
                                return Err(serde::de::Error::duplicate_field("largestKey"));
                            }
                            largest_key = Some(
                                map.next_value::<::pbjson::private::BytesDeserialize<_>>()?.0
                            );
                ...
                Ok(SstableMeta {
                    block_metas: block_metas.unwrap_or_default(),
                    bloom_filter: bloom_filter.unwrap_or_default(),
                    estimated_size: estimated_size.unwrap_or_default(),
                    key_count: key_count.unwrap_or_default(),
                    smallest_key: smallest_key.unwrap_or_default(),
                    largest_key: largest_key.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("hummock.SstableMeta", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SubscribeCompactTasksRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("hummock.SubscribeCompactTasksRequest", len)?;
        struct_ser.end()
    }
}
...
impl serde::Serialize for UnpinVersionRequest {
        ...
        S: serde::Serializer,
    {
        ...
        if self.pinned_version_id != 0 {
            struct_ser.serialize_field("pinnedVersionId", ToString::to_string(&self.pinned_version_id).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for UnpinVersionRequest {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "contextId" => Ok(GeneratedField::ContextId),
                            "pinnedVersionId" => Ok(GeneratedField::PinnedVersionId),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            {
                let mut context_id = None;
                let mut pinned_version_id = None;
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::ContextId => {
                            if context_id.is_some() {
                        ...
                        GeneratedField::PinnedVersionId => {
                            if pinned_version_id.is_some() {
                                return Err(serde::de::Error::duplicate_field("pinnedVersionId"));
                            }
                            pinned_version_id = Some(
                                map.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0
                            );
                        }
                    }
                ...
                Ok(UnpinVersionRequest {
                    context_id: context_id.unwrap_or_default(),
                    pinned_version_id: pinned_version_id.unwrap_or_default(),
                })
            }
        }
