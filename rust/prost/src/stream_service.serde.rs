...
impl serde::Serialize for ForceStopActorsRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("stream_service.ForceStopActorsRequest", len)?;
        if !self.request_id.is_empty() {
            struct_ser.serialize_field("requestId", &self.request_id)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ForceStopActorsRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ForceStopActorsRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct stream_service.ForceStopActorsRequest")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<ForceStopActorsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut request_id = None;
                ...
                Ok(ForceStopActorsRequest {
                    request_id: request_id.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("stream_service.ForceStopActorsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ForceStopActorsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("stream_service.ForceStopActorsResponse", len)?;
        if !self.request_id.is_empty() {
            struct_ser.serialize_field("requestId", &self.request_id)?;
        }
        if let Some(v) = self.status.as_ref() {
...
impl<'de> serde::Deserialize<'de> for ForceStopActorsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ForceStopActorsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct stream_service.ForceStopActorsResponse")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<ForceStopActorsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut request_id = None;
                ...
                Ok(ForceStopActorsResponse {
                    request_id: request_id.unwrap_or_default(),
                    status,
                })
            }
        }
        deserializer.deserialize_struct("stream_service.ForceStopActorsResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for InjectBarrierResponse {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.finished_create_mviews.is_empty() {
            len += 1;
        }
        ...
        if !self.finished_create_mviews.is_empty() {
            struct_ser.serialize_field("finishedCreateMviews", &self.finished_create_mviews)?;
        }
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "requestId" => Ok(GeneratedField::RequestId),
                            "status" => Ok(GeneratedField::Status),
                            "finishedCreateMviews" => Ok(GeneratedField::FinishedCreateMviews),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                let mut request_id = None;
                let mut status = None;
                let mut finished_create_mviews = None;
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::RequestId => {
                            if request_id.is_some() {
                        ...
                        GeneratedField::FinishedCreateMviews => {
                            if finished_create_mviews.is_some() {
                                return Err(serde::de::Error::duplicate_field("finishedCreateMviews"));
                            }
                            finished_create_mviews = Some(map.next_value()?);
                        }
                    }
                }
                Ok(InjectBarrierResponse {
                    request_id: request_id.unwrap_or_default(),
                    status,
                    finished_create_mviews: finished_create_mviews.unwrap_or_default(),
                })
            }
        }
...
impl serde::Serialize for inject_barrier_response::FinishedCreateMview {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("stream_service.InjectBarrierResponse.FinishedCreateMview", len)?;
        if self.epoch != 0 {
...
impl<'de> serde::Deserialize<'de> for inject_barrier_response::FinishedCreateMview {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = inject_barrier_response::FinishedCreateMview;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct stream_service.InjectBarrierResponse.FinishedCreateMview")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<inject_barrier_response::FinishedCreateMview, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch = None;
                ...
                Ok(inject_barrier_response::FinishedCreateMview {
                    epoch: epoch.unwrap_or_default(),
                    actor_id: actor_id.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("stream_service.InjectBarrierResponse.FinishedCreateMview", FIELDS, GeneratedVisitor)
    }
}
