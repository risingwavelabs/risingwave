...
use risingwave_pb::hummock::{
    ...
    HummockSnapshot, HummockStaleSstables, HummockVersion, Level, LevelType, SstableInfo,
...
use crate::hummock::model::{
    CurrentHummockVersionId, HummockPinnedSnapshotExt, HummockPinnedVersionExt,
};
    ...
    S: MetaStore,
{
    ...
    pub async fn add_tables(
        ...
        let old_version_id = current_version_id_copy.id();
    ...
    pub async fn report_compact_task(
        ...
        let mut transaction = Transaction::default();
        let mut compact_status_copy = compaction_guard.compact_status.clone();
        let (sorted_output_ssts, delete_table_ids) = match compact_status_copy.report_compact_task(
        ...
        if task_result {
            ...
            let old_version = versioning_guard
                ...
                .get(&old_version_id)
                .unwrap();
            let mut new_version = HummockVersion {
                id: new_version_id,
