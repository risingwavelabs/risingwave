...
pub(crate) fn is_parallelized_backfill_enabled_cdc_scan_fragment(
    ...
    is_parallelized_backfill_enabled_cdc_scan_fragment_impl(
...
pub(crate) fn is_parallelized_backfill_enabled_cdc_scan_fragment_impl(
...
pub(crate) fn parallel_cdc_table_backfill_fragment<'a>(
    ...
    let mut stream_scan_fragments =
        fragments.filter(|f| is_parallelized_backfill_enabled_cdc_scan_fragment(f).is_some());
