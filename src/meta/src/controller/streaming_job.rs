...
use crate::controller::utils::{
    ...
    get_fragment_mappings, get_internal_tables_by_id, get_table_columns,
...
impl CatalogController {
    ...
    pub async fn finish_replace_streaming_job_inner(
        ...
        // TODO: fragment mapping notification is under removal, no need to also notify sink fragment change here
