...
pub mod tests {
    ...
    pub fn push_table_level0_overlapping(levels: &mut Levels, sst: SstableInfo) {
        levels.l0.as_mut().unwrap().total_file_size += sst.get_estimated_sst_size();
        levels.l0.as_mut().unwrap().sub_levels.push(Level {
            level_idx: 0,
            level_type: LevelType::Overlapping as i32,
            total_file_size: sst.get_estimated_sst_size(),
    ...
    pub fn generate_table_with_ids_and_epochs(
        ...
        SstableInfo {
            ...
            min_epoch,
            max_epoch,
            estimated_sst_size: object_file_size,
            ..Default::default()
        }
    }
    ...
    pub fn generate_tables(
        ...
        for id in ids {
            ...
            table.estimated_sst_size = file_size;
            tables.push(table);
            start += step;
        }
        tables
        ...
        OverlappingLevel {
            sub_levels: table_infos
                ...
                .map(|(idx, table)| Level {
                    level_idx: 0,
                    level_type: LevelType::Nonoverlapping as i32,
                    total_file_size: table.estimated_sst_size,
