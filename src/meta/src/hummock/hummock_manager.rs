...
use risingwave_pb::hummock::{
    ...
    HummockPinnedVersion, HummockSnapshot, HummockStaleSstables, HummockVersion,
    HummockVersionObjectRef, Level, LevelType, SstableIdInfo, SstableInfo,
};
    ...
    S: MetaStore,
{
    ...
    pub async fn read_hummock_version_object(&self, object_id: u64) -> Result<HummockVersion> {
        ...
        let bytes = self
            ...
            .await
            .map_err(|e| Error::ObjectStoreError(Box::new(e)))?;
