...
use crate::manager::{
    ...
    StreamingJobDiscriminants, IGNORED_NOTIFICATION_VERSION,
};
        ...
        let fut = async move {
            match command {
                ...
                DdlCommand::ReplaceTable(ReplaceTableInfo {
                    ...
                    ctrl.replace_table_v2(streaming_job, fragment_graph, col_index_mapping)
                        .await
                }
