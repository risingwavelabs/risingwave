...
static SERVER_START_TIME: OnceLock<chrono::DateTime<chrono::Utc>> = OnceLock::new();
...
pub fn get_server_start_time() -> Option<chrono::DateTime<chrono::Utc>> {
    SERVER_START_TIME.get().cloned()
}
