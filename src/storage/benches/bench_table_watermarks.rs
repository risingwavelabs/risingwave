...
fn bench_table_watermarks(c: &mut Criterion) {
    ...
    c.bench_function("read latest watermark", |b| {
        b.iter(|| {
            for i in 0..VirtualNode::DEFAULT_COUNT {
