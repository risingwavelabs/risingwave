            ...
            vec![
                LocalSstableInfo::for_test(SstableInfo {
                    ...
                    key_range: Some(KeyRange {
                        left: key_with_epoch(iterator_test_user_key_of::<true>(1).encode(), 1),
                        right: key_with_epoch(iterator_test_user_key_of::<true>(2).encode(), 2),
                ...
                LocalSstableInfo::for_test(SstableInfo {
                    ...
                    sst_id: 2,
                    key_range: Some(KeyRange {
                        left: key_with_epoch(iterator_test_user_key_of::<true>(3).encode(), 3),
                        right: key_with_epoch(iterator_test_user_key_of::<true>(3).encode(), 3),
                        right_exclusive: false,
                    }),
                    file_size: 1,
                    table_ids: vec![0],
