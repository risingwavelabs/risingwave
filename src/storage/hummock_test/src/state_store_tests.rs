    ...
    // Test local state store read for replicated data.
    {
        ...
        let expected = expect![[r#"
            [
                Ok(
                    (
                        FullKey { UserKey { 233, TableKey { 000061616161 } }, epoch: 65536, epoch_with_gap: 65536, spill_offset: 0} table_id 233 vnode 0,
                        b"1111",
                    ),
                ),
                Ok(
                    (
                        FullKey { UserKey { 233, TableKey { 000062626262 } }, epoch: 65536, epoch_with_gap: 65536, spill_offset: 0} table_id 233 vnode 0,
                        b"2222",
                    ),
                ),
            ]
    ...
    // Test Global State Store iter, epoch2
    {
        ...
        let expected = expect![[r#"
            [
                Ok(
                    (
                        FullKey { UserKey { 233, TableKey { 000063636363 } }, epoch: 131072, epoch_with_gap: 131072, spill_offset: 0} table_id 233 vnode 0,
                        b"3333",
                    ),
                ),
                Ok(
                    (
                        FullKey { UserKey { 233, TableKey { 000064646464 } }, epoch: 131072, epoch_with_gap: 131072, spill_offset: 0} table_id 233 vnode 0,
                        b"4444",
                    ),
                ),
            ]
