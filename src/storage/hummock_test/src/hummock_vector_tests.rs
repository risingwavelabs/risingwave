...
use risingwave_pb::catalog::{
    PbFlatIndexConfig, PbHnswFlatIndexConfig, PbVectorIndexInfo, vector_index_info,
};
...
use risingwave_storage::vector::{NearestBuilder, Vector, VectorDistance, VectorRef};
        ...
        .register_vector_index(
            ...
            PbVectorIndexInit {
                info: Some(PbVectorIndexInfo {
                    dimension: VECTOR_DIM as _,
                    distance_type: PbDistanceType::InnerProduct as _,
                    config: Some(vector_index_info::PbConfig::HnswFlat(
            ...
            let output = read_snapshot_epoch
                .nearest(
                    ...
                    VectorNearestOptions {
                        top_n,
                        measure: DistanceMeasurement::InnerProduct,
                        // Set a high ef_search for HNSW so that it can return the same results as flat index.
                        hnsw_ef_search: 300,
                    },
                    on_nearest_item,
                )
