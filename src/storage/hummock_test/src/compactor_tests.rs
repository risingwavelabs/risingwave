...
pub(crate) mod tests {
    ...
    async fn test_skip_watermark() {
        ...
        for object_id in 1..3 {
            ...
            let key_count = KEY_COUNT / VirtualNode::DEFAULT_COUNT * 2;
            for vnode_id in 0..VirtualNode::DEFAULT_COUNT / 2 {
                let mut last_k: u64 = 1;
                let init_epoch = test_epoch(100 * object_id);
                let mut last_epoch = init_epoch;
                for idx in 0..key_count {
        ...
        let key_count = KEY_COUNT / VirtualNode::DEFAULT_COUNT * 2;
        let mut vnode_builder = BitmapBuilder::zeroed(VirtualNode::DEFAULT_COUNT);
        for i in 0..VirtualNode::DEFAULT_COUNT / 2 {
            if i % 2 == 0 {
