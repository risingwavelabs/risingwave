...
pub struct StorageOpts {
    ...
    pub meta_file_cache_blob_index_size: usize,
...
impl From<(&RwConfig, &SystemParamsReader, &StorageMemoryConfig)> for StorageOpts {
    fn from((c, p, s): (&RwConfig, &SystemParamsReader, &StorageMemoryConfig)) -> Self {
        ...
        Self {
            ...
            data_file_cache_blob_index_size: c.storage.data_file_cache.blob_index_size,
            ...
            meta_file_cache_blob_index_size: c.storage.meta_file_cache.blob_index_size,
