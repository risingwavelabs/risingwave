...
pub(crate) mod tests {
    ...
    async fn test_uploader_basic() {
        ...
        let new_pinned_version = uploader
            .context
            .pinned_version
            .new_pin_version(test_hummock_version(epoch1)).unwrap();
    ...
    async fn test_uploader_empty_advance_mce() {
        ...
        let version1 = initial_pinned_version.new_pin_version(test_hummock_version(epoch1)).unwrap();
        let version2 = initial_pinned_version.new_pin_version(test_hummock_version(epoch2)).unwrap();
        let version3 = initial_pinned_version.new_pin_version(test_hummock_version(epoch3)).unwrap();
        let version4 = initial_pinned_version.new_pin_version(test_hummock_version(epoch4)).unwrap();
        let version5 = initial_pinned_version.new_pin_version(test_hummock_version(epoch5)).unwrap();
