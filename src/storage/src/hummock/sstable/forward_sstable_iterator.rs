...
impl SstableIterator {
    pub fn new(
        ...
        let mut block_end_idx_inclusive = block_meta_count - 1;
        assert!(
        ...
        while block_end_idx_inclusive > block_start_idx_inclusive
            && meta_handle.block_meta(block_end_idx_inclusive).table_id() > read_table_id_range.1
        {
            ...
            if next_to_start_idx <= self.block_end_idx_inclusive {
                let end_idx = match bound {
                    ...
                    Included(dest_key) => {
                        ...
                        meta_handle.block_metas_partition_point(
