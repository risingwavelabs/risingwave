...
use risingwave_pb::hummock::vector_index_delta::{PbVectorIndexAdd, vector_index_add};
use risingwave_pb::hummock::{FlatIndexAdd, PbVectorFileInfo};
...
use crate::hummock::{
    GetObjectId, HummockError, HummockResult, SstableObjectIdManagerRef, SstableStoreRef,
};
use crate::store::*;
...
pub struct HummockVectorWriter {
    ...
    flushed_vector_files: Vec<PbVectorFileInfo>,
...
impl StateStoreWriteEpochControl for HummockVectorWriter {
        ...
        let _ = self
            ...
            .send(HummockEvent::VectorWriterSealEpoch {
                ...
                add: PbVectorIndexAdd {
                    add: Some(vector_index_add::Add::Flat(FlatIndexAdd {
    ...
    async fn flush(&mut self) -> StorageResult<usize> {
            ...
            && let Some(block) = builder.finish()
        {
            ...
            self.flushed_vector_files.push(PbVectorFileInfo {
                object_id,
                min_epoch: epoch,
                max_epoch: epoch,
