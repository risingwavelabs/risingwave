...
use prometheus::{
    Histogram, HistogramVec, Registry, exponential_buckets, histogram_opts, linear_buckets,
...
pub struct MonitoredStorageMetrics {
    ...
    pub vector_nearest_duration: HistogramVec,
...
impl MonitoredStorageMetrics {
    pub fn new(registry: &Registry, metric_level: MetricLevel) -> Self {
        ...
        let vector_nearest_duration = register_histogram_vec_with_registry!(
