...
use crate::version::{HummockVersion, HummockVersionStateTableInfo};
        ...
        Self {
            ...
            table_change_log: pb_version
                ...
                .map(|(table_id, change_log)| {
                    let incomplete_table_change_log = TableChangeLog::from_protobuf(change_log)
                        .0
                        .iter()
                    ...
                    (
                        TableId::new(*table_id),
                        TableChangeLog(incomplete_table_change_log),
                    )
                })
                .collect(),
        ...
        Self {
            ...
            change_log_delta: delta
                ...
                .map(|(table_id, log_delta)| {
                    (
                        TableId::new(*table_id),
                        stripped_change_log_delta(log_delta),
                    )
                })
                .collect(),
