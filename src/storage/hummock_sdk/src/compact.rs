        ...
        let tables: Vec<String> = level_entry
            ...
            .map(|table| {
                ...
                if table.total_key_count != 0 {
                    format!(
                        "[id: {}, obj_id: {} object_size {}KB estimated_sst_size {}KB stale_ratio {}]",
                        table.sst_id,
                        table.object_id,
                    ...
                    format!(
                        "[id: {}, obj_id: {} object_size {}KB estimated_sst_size {}KB]",
                        table.sst_id,
                        table.object_id,
                        table.file_size / 1024,
                        table.estimated_sst_size / 1024,
...
pub fn append_sstable_info_to_string(s: &mut String, sstable_info: &SstableInfo) {
    ...
    writeln!(
        s,
        "SstableInfo: object id={}, SST id={}, KeyRange=[{:?},{:?}], table_ids: {:?}, object_size={}KB, estimated_sst_size={}KB stale_ratio={}%, bloom_filter_kind {:?}",
        ...
        sstable_info.estimated_sst_size / 1024,
        stale_ratio,
