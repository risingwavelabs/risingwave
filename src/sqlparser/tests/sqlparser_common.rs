...
fn parse_explain_with_invalid_options() {
    ...
    let expected = "sql parser error: expected one of BACKFILL or VERBOSE or TRACE or TYPE or LOGICAL or PHYSICAL or DISTSQL or FORMAT or DURATION_SECS or BATCH, found: )";
