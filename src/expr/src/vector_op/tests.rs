...
fn test_comparison() {
    ...
    assert!(general_is_distinct_from::<Decimal, i32, Decimal>(Some(Decimal::from_str("1.0").unwrap()), Some(2)).unwrap());
    assert!(general_is_distinct_from::<Decimal, f32, Decimal>(Some(Decimal::from_str("1.0").unwrap()), Some(2.0)).unwrap());
    assert!(general_is_distinct_from::<Decimal, f32, Decimal>(Some(Decimal::from_str("1.0").unwrap()), None).unwrap());
    assert!(general_is_distinct_from::<Decimal, i32, Decimal>(None, Some(1)).unwrap());
    assert!(!general_is_distinct_from::<Decimal, i32, Decimal>(Some(Decimal::from_str("1.0").unwrap()), Some(1)).unwrap());
    assert!(!general_is_distinct_from::<Decimal, f32, Decimal>(Some(Decimal::from_str("1.0").unwrap()), Some(1.0)).unwrap());
    ...
    assert!(!general_is_distinct_from::<OrderedF32, i32, OrderedF64>(Some(1.0.into()), Some(1)).unwrap());
