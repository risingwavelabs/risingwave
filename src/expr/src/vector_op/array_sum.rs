...
#[function("array_sum(int16[]) -> int64")]
fn array_sum_int16(list: ListRef<'_>) -> Result<Option<i64>> {
    array_sum_general::<i16, i64>(list)
}

#[function("array_sum(int32[]) -> int64")]
fn array_sum_int32(list: ListRef<'_>) -> Result<Option<i64>> {
    array_sum_general::<i32, i64>(list)
}

#[function("array_sum(int64[]) -> decimal")]
fn array_sum_int64(list: ListRef<'_>) -> Result<Option<Decimal>> {
