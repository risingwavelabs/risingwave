...
#[function(
    "date_part(varchar, date) -> float64",
    prebuild = "Unit::from_str($0)?.ensure_date()?"
)]
...
#[function(
    "date_part(varchar, time) -> float64",
    prebuild = "Unit::from_str($0)?.ensure_time()?"
)]
...
#[function(
    "date_part(varchar, timestamp) -> float64",
    prebuild = "Unit::from_str($0)?.ensure_timestamp()?"
)]
...
#[function(
    "date_part(varchar, timestamptz) -> float64",
    prebuild = "Unit::from_str($0)?.ensure_timestamptz()?"
)]
...
#[function(
    "date_part(varchar, timestamptz, varchar) -> float64",
    prebuild = "Unit::from_str($0)?.ensure_timestamptz_at_timezone()?"
)]
...
#[function(
    "date_part(varchar, interval) -> float64",
    prebuild = "Unit::from_str($0)?.ensure_interval()?"
)]
