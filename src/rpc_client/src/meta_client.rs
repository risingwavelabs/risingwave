...
impl MetaClient {
    ...
    pub async fn get_fragment_vnodes(&self, fragment_id: u32) -> Result<GetFragmentVnodesResponse> {
        let request = GetFragmentVnodesRequest { fragment_id };
        self.inner.get_fragment_vnodes(request).await
    }
