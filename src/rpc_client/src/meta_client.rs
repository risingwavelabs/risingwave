...
use risingwave_pb::hummock::{
    ...
    TriggerManualCompactionRequest, TriggerManualCompactionResponse, UnpinSnapshotBeforeRequest,
    UnpinSnapshotBeforeResponse, UnpinSnapshotRequest, UnpinSnapshotResponse, UnpinVersionRequest,
    UnpinVersionResponse, VacuumTask,
};
