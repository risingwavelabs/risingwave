...
async fn test_adaptive_strategy_create() -> Result<()> {
    ...
    session
        .run("select distinct parallelism from rw_fragment_parallelism where name = 't_auto' and distribution_type = 'HASH';")
        .await?
        .assert_result_eq("6");
    ...
    session
        .run("select distinct parallelism from rw_fragment_parallelism where name = 't_full' and distribution_type = 'HASH';")
        .await?
        .assert_result_eq("6");
    ...
    session
        .run("select distinct parallelism from rw_fragment_parallelism where name = 't_bounded_2' and distribution_type = 'HASH';")
        .await?
        .assert_result_eq("2");
    ...
    session
        .run("select distinct parallelism from rw_fragment_parallelism where name = 't_ratio_half' and distribution_type = 'HASH';")
        .await?
        .assert_result_eq("3");
    ...
    session
        .run("select distinct parallelism from rw_fragment_parallelism where name = 't_ratio_min' and distribution_type = 'HASH';")
        .await?
        .assert_result_eq("1");
