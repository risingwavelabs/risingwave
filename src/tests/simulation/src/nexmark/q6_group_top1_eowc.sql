-- Copied from q6_group_top1, but runs in Emit-On-Window-Close mode.
-- Covers EOWC sort + EOWC over window + GroupTopN rewrite.

CREATE MATERIALIZED VIEW nexmark_q6_group_top1_eowc
AS
SELECT
    Q.seller,
    AVG(Q.final) OVER
