...
impl<'a, R: Rng> SqlGenerator<'a, R> {
    ...
    // This function is workaround due to some feature of correlated subquery is not yet implmented.
    // Tracking issues: https://github.com/risingwavelabs/risingwave/issues/3896
