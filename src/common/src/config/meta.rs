...
pub struct CompactionConfig {
    ...
    /// Per-level SST filter family for compaction output. Supported values are `xor8`, `xor16`,
    /// `binary_fuse8`, and `binary_fuse16`.
    ///
    ...
    /// Per-level SST filter layout for compaction output.
    ///
