    ...
    let mut visit_body = |body: &mut NodeBody| {
        match body {
            ...
            NodeBody::Materialize(node) if !internal_tables_only => {
                // Plan directly generated by frontend may not have the table filled.
                // It is filled by the meta service during building fragments.
                // Thus it's marked as optional here.
                optional!(node.table, "Materialize")
            }
