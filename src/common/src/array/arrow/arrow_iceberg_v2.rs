...
pub struct IcebergV2ArrowConvert;

impl ToArrow for IcebergV2ArrowConvert {
    #[inline]
...
impl FromArrow for IcebergV2ArrowConvert {}

pub fn to_record_batch_for_iceberg_v2(
    schema: arrow_schema::SchemaRef,
    chunk: &DataChunk,
) -> Result<arrow_array::RecordBatch, ArrayError> {
    IcebergV2ArrowConvert.to_record_batch(schema, chunk)
}

pub fn from_record_batch_for_iceberg_v2(
    batch: &arrow_array::RecordBatch,
) -> Result<DataChunk, ArrayError> {
    IcebergV2ArrowConvert.from_record_batch(batch)
}
