...
mod tests {
    ...
    async fn test_json_parser() {
        ...
        for payload in [
            br#"{"i32":1,"bool":true,"i16":1,"i64":1673000000,"f32":1.23,"f64":1.2345,"varchar":"varchar","date":"2021-01-01","timestamp":"2021-01-01 16:06:12.269","decimal":12345.67890}"#.as_slice(),
