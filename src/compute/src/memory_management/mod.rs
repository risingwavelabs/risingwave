...
pub fn storage_memory_config(
    ...
    let file_cache_total_buffer_capacity_mb =
        storage_config.file_cache.buffer_pool_size_mb.unwrap_or(
            ((non_reserved_memory_bytes as f64
                * storage_memory_proportion
...
mod tests {
    ...
    fn test_storage_memory_config() {
        ...
        assert_eq!(memory_config.file_cache_buffer_pool_size_mb, 245);
        ...
        storage_config.file_cache.buffer_pool_size_mb = Some(1024);
        ...
        assert_eq!(memory_config.file_cache_buffer_pool_size_mb, 1024);
