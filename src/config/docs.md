...
| enable_automatic_parallelism_control |  Whether to enable auto-scaling feature. | false |
...
| enable_scale_in_when_recovery |  Whether to enable scale-in when recovery. | false |
...
| Config | Description | Default |
|--------|-------------|---------|
| backup_storage_directory | Remote directory for storing snapshots. | "backup" |
| backup_storage_url | Remote storage url for storing snapshots. | "memory" |
