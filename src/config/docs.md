...
| adaptive_parallelism_strategy_for_index | The strategy for Adaptive Parallelism for index. | "AUTO" |
| adaptive_parallelism_strategy_for_materialized_view | The strategy for Adaptive Parallelism for materialized view. | "AUTO" |
| adaptive_parallelism_strategy_for_sink | The strategy for Adaptive Parallelism for sink. | "AUTO" |
| adaptive_parallelism_strategy_for_source | The strategy for Adaptive Parallelism for source. | "AUTO" |
| adaptive_parallelism_strategy_for_table | The strategy for Adaptive Parallelism for table. | "AUTO" |
...
| streaming_parallelism_for_index | The number of parallelism for streaming index. | 0 |
| streaming_parallelism_for_materialized_view | The number of parallelism for streaming materialized view. | 0 |
| streaming_parallelism_for_sink | The number of parallelism for streaming sink. | 0 |
| streaming_parallelism_for_source | The number of parallelism for streaming source. | 0 |
| streaming_parallelism_for_table | The number of parallelism for streaming table. | 0 |
