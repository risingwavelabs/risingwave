...
| table_stat_sample_size | The size of table throughput statistics sample. | 240 |
| table_stat_sample_size_for_merge | The window times of table statistic history for merge compaction group. | 240 |
| table_stat_sample_size_for_split | The window times of table statistic history for split compaction group. | 60 |
| unrecognized |  |  |
