...
| snapshot_backfill_barrier_amplification_factor | The maximum number of pending barriers injected into a snapshot backfill job for each new upstream barrier. Values below 2 are treated as 2. | 100 |
