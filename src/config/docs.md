...
| sstable_filter_kind | Per-level SST filter family for compaction output. Supported values are `xor8`, `xor16`, `binary_fuse8`, and `binary_fuse16`. Index by LSM level: `0..=max_level`. Note: L0 (index 0) is currently ignored by shared-buffer flush, which always uses `xor16`. | ["xor16", "xor16", "xor16", "xor16", "xor16", "xor16", "xor16"] |
| sstable_filter_layout | Per-level SST filter layout for compaction output. "auto" uses the kv-count heuristic; "plain"/"normal" forces non-blocked filters and ignores kv-count threshold. Index by LSM level: `0..=max_level`. Note: L0 (index 0) is currently ignored by shared-buffer flush, which always uses "auto". | ["auto", "auto", "auto", "auto", "auto", "auto", "auto"] |
