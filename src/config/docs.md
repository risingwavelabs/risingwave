...
| pause_on_next_bootstrap_offline | Whether meta should request pausing all data sources on the next bootstrap. This is a convenience switch that sets the `pause_on_next_bootstrap` system parameter when the meta service starts. | false |
