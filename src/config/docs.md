...
| table_stat_throuput_window_seconds_for_merge | The window times of table statistic history for merge compaction group. | 240 |
| table_stat_throuput_window_seconds_for_split | The window times of table statistic history for split compaction group. | 60 |
| unrecognized |  |  |
