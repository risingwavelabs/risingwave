...
| periodic_purge_stale_compaction_group_interval_sec | Interval of reconciling live state tables and purging stale dynamic compaction groups. Defaults to 1 hour. Set to 0 to disable the periodic purge. | 3600 |
