...
| enable_compaction_group_normalize | When enabled, automatically splits compaction groups whose table-id ranges overlap into non-overlapping groups before the regular split/merge scheduling. | false |
