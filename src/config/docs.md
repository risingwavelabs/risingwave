...
| enable_legacy_table_migration | Whether to automatically regenerate all existing table fragments in the background when meta starts (for compatibility with the new sink-into-table implementation) | true |
