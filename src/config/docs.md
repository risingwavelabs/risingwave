...
| join_hash_map_evict_interval_rows | Number of processed rows between periodic join cache evictions. Set to 0 to disable the periodic eviction and rely on LRU capacity only. | 16 |
