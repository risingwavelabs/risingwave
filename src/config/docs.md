...
| tracing_threshold_tiered_cache_read_ms | Threshold to record tiered cache read with minitrace. | 1000 |
| tracing_threshold_tiered_cache_write_ms | Threshold to record tiered cache write with minitrace. | 1000 |
