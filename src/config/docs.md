...
| blocked_xor_filter_kv_count_threshold | KV-count threshold for using blocked xor filter when layout is "auto". | 262144 |
...
| sstable_filter_kind | Per-level xor filter family for compaction output. Index by LSM level: [0..max_level]. Note: L0 (index 0) is currently ignored by shared-buffer flush. | ["xor16", "xor16", "xor16", "xor16", "xor16", "xor16", "xor16"] |
| sstable_filter_layout | Per-level xor filter layout for compaction output. "auto" uses kv-count heuristic; "plain/normal" forces non-blocked. Index by LSM level: [0..max_level]. Note: L0 (index 0) is currently ignored by shared-buffer flush. | ["auto", "auto", "auto", "auto", "auto", "auto", "auto"] |
