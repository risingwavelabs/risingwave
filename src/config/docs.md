...
| join_hash_map_evict_interval_rows | Number of processed rows between periodic join cache evictions. Values smaller than 1 are clamped to 1 by the executor. | 16 |
