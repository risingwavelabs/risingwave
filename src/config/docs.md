...
| iceberg_pk_index_coordinated_compaction_enabled | Whether to route iceberg pk-index sink compaction through the meta-coordinated commit path instead of committing directly from the compactor. Off by default. | false |
