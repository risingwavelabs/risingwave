...
| sstable_filter_type | Per-level xor filter family for compaction output. Index by LSM level: `0..=max_level`. Note: L0 (index 0) is currently ignored by shared-buffer flush, which always uses "xor16". | ["xor16", "xor16", "xor16", "xor16", "xor16", "xor8", "xor8"] |
