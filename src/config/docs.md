...
| unsafe_enable_oracle_cdc | Whether to allow the experimental `oracle-cdc` connector. Disabled by default while Oracle CDC support is incomplete and not yet public. | false |
