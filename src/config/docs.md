...
| pause_on_next_bootstrap_offline | Whether meta should pause all data sources during the next bootstrap by setting the `pause_on_next_bootstrap` system parameter. | false |
