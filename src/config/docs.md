...
| enable_over_window_multi_range | Enable multi-range optimization for bounded `ROWS` over window frames. When disabled, executor falls back to the legacy single-range behavior. | true |
