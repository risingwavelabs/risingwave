...
| iceberg_compaction_memory_limit_mb | Maximum heap memory for compaction tasks in the dedicated Iceberg compactor, in megabytes. When unset, the budget is derived from the compactor's available memory. | "" |
