...
| audit_log_retention_days | Retention of audit log rows in days. Set 0 to disable cleanup. | 30 |
| audit_log_cleanup_interval_sec | Interval of running audit log cleanup task. | 3600 |
