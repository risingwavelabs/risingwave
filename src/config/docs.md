...
| compaction_group_size_threshold | Whether to split the compaction group when the size of the group exceeds the threshold. | 0.9 |
...
| split_group_statistic_window_times | The window times of table statistic history for split compaction group. | 60 |
...
| table_statistic_high_write_throughput_ratio | To split the compaction group when the high throughput statistics of the group exceeds the threshold. | 0.5 |
| table_statistic_low_write_throughput_ratio | To merge the compaction group when the low throughput statistics of the group exceeds the threshold. | 0.7 |
| unrecognized |  |  |
