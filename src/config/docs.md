...
| Config | Description | Default |
|--------|-------------|---------|
| cursor_data_chunk_channel_capacity | Capacity of the channel buffering data chunks and barrier events between each cursor's asynchronous producer and its `FETCH` stream. Must be greater than `0`. | 10 |
