    ...
    ($macro:path $(, $extra_args:tt)*) => {
        $macro! {
            ...
            // todo: file source do not nest with mq source.
            {
                ...
                { BatchPosixFs, $crate::source::filesystem::opendal_source::BatchPosixFsProperties, $crate::source::filesystem::OpendalFsSplit<$crate::source::filesystem::opendal_source::OpendalBatchPosixFs> },
