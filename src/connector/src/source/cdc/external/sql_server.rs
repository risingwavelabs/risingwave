...
impl SqlServerExternalTable {
    pub async fn connect(config: ExternalTableConfig) -> ConnectorResult<Self> {
        ...
        println!("WKXMSSQLLOG SqlServerExternalTable Config");
        ...
        println!("WKXMSSQLLOG Connected to the server");
...
impl SqlServerExternalTableReader {
    pub async fn new(
        ...
        let mut client_config = Config::new();
        println!("WKXMSSQLLOG SqlServerExternalTableReader Config");
