...
use risingwave_common::metrics::{
    register_guarded_int_gauge_vec_with_registry, LabelGuardedIntGaugeVec,
};
...
pub struct RdKafkaStats {
    ...
    pub msg_cnt: LabelGuardedIntGaugeVec<2>,
    pub msg_size: LabelGuardedIntGaugeVec<2>,
    pub msg_max: LabelGuardedIntGaugeVec<2>,
    pub msg_size_max: LabelGuardedIntGaugeVec<2>,
...
pub struct BrokerStats {
    ...
    pub tx: LabelGuardedIntGaugeVec<4>,
    pub tx_bytes: LabelGuardedIntGaugeVec<4>,
    pub tx_errs: LabelGuardedIntGaugeVec<4>,
    pub tx_retries: LabelGuardedIntGaugeVec<4>,
    pub tx_idle: LabelGuardedIntGaugeVec<4>,
    pub req_timeouts: LabelGuardedIntGaugeVec<4>,
    pub rx: LabelGuardedIntGaugeVec<4>,
    pub rx_bytes: LabelGuardedIntGaugeVec<4>,
    pub rx_errs: LabelGuardedIntGaugeVec<4>,
    pub rx_corriderrs: LabelGuardedIntGaugeVec<4>,
    pub rx_partial: LabelGuardedIntGaugeVec<4>,
    pub rx_idle: LabelGuardedIntGaugeVec<4>,
    pub req: LabelGuardedIntGaugeVec<5>,
    pub zbuf_grow: LabelGuardedIntGaugeVec<4>,
    pub buf_grow: LabelGuardedIntGaugeVec<4>,
    pub wakeups: LabelGuardedIntGaugeVec<4>,
...
pub struct ConsumerGroupStats {
    ...
    // todo: (do not know value set) join_state: LabelGuardedIntGaugeVec<2>,
...
pub struct PartitionStats {
    ...
    pub msgq_bytes: LabelGuardedIntGaugeVec<4>,
    pub xmit_msgq_cnt: LabelGuardedIntGaugeVec<4>,
    pub xmit_msgq_bytes: LabelGuardedIntGaugeVec<4>,
    pub fetchq_cnt: LabelGuardedIntGaugeVec<4>,
    pub fetchq_size: LabelGuardedIntGaugeVec<4>,
    ...
    pub txmsgs: LabelGuardedIntGaugeVec<4>,
    pub txbytes: LabelGuardedIntGaugeVec<4>,
    pub rxmsgs: LabelGuardedIntGaugeVec<4>,
    pub rxbytes: LabelGuardedIntGaugeVec<4>,
    pub msgs: LabelGuardedIntGaugeVec<4>,
    pub rx_ver_drops: LabelGuardedIntGaugeVec<4>,
    ...
    pub acked_msgid: LabelGuardedIntGaugeVec<4>,
}
...
impl PartitionStats {
    pub fn new(registry: Registry) -> Self {
        ...
        .unwrap();
        let msgq_bytes = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let xmit_msgq_bytes = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let fetchq_size = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let txmsgs = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let rxbytes = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let msgs = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let rx_ver_drops = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let acked_msgid = register_guarded_int_gauge_vec_with_registry!(
    ...
    fn report_inner(&self, id: &str, client_id: &str, topic: &str, stats: &Partition) {
        ...
        self.msgq_bytes
            .with_guarded_label_values(&labels)
            .set(stats.msgq_bytes as i64);
        self.xmit_msgq_cnt
            .with_guarded_label_values(&labels)
            .set(stats.xmit_msgq_cnt);
        self.xmit_msgq_bytes
            .with_guarded_label_values(&labels)
            .set(stats.xmit_msgq_bytes as i64);
        self.fetchq_cnt
            .with_guarded_label_values(&labels)
            .set(stats.fetchq_cnt);
        self.fetchq_size
            .with_guarded_label_values(&labels)
            .set(stats.fetchq_size as i64);
        self.query_offset
            .with_guarded_label_values(&labels)
        ...
        self.txmsgs
            .with_guarded_label_values(&labels)
            .set(stats.txmsgs as i64);
        self.txbytes
            .with_guarded_label_values(&labels)
            .set(stats.txbytes as i64);
        self.rxmsgs
            .with_guarded_label_values(&labels)
            .set(stats.rxmsgs as i64);
        self.rxbytes
            .with_guarded_label_values(&labels)
            .set(stats.rxbytes as i64);
        self.msgs
            .with_guarded_label_values(&labels)
            .set(stats.msgs as i64);
        self.rx_ver_drops
            .with_guarded_label_values(&labels)
            .set(stats.rx_ver_drops as i64);
        self.msgs_inflight
            .with_guarded_label_values(&labels)
...
impl RdKafkaStats {
    pub fn new(registry: Registry) -> Self {
        ...
        .unwrap();
        let msg_cnt = register_guarded_int_gauge_vec_with_registry!(
            "rdkafka_top_msg_cnt",
        ...
        .unwrap();
        let msg_size_max = register_guarded_int_gauge_vec_with_registry!(
    ...
    pub fn report(&self, id: &str, stats: &Statistics) {
        ...
        self.msg_size
            .with_guarded_label_values(&[id, client_id])
            .set(stats.msg_size as i64);
        self.msg_max
            .with_guarded_label_values(&[id, client_id])
            .set(stats.msg_max as i64);
        self.msg_size_max
            .with_guarded_label_values(&[id, client_id])
            .set(stats.msg_size_max as i64);
        self.tx
            .with_guarded_label_values(&[id, client_id])
            .set(stats.tx);
        self.tx_bytes
...
impl BrokerStats {
    pub fn new(registry: Registry) -> Self {
        ...
        .unwrap();
        let tx_errs = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let tx_retries = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let req_timeouts = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let rx_errs = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let rx_corriderrs = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let rx_partial = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let zbuf_grow = register_guarded_int_gauge_vec_with_registry!(
        ...
        .unwrap();
        let wakeups = register_guarded_int_gauge_vec_with_registry!(
    ...
    fn report_inner(&self, id: &str, client_id: &str, stats: &Broker) {
        ...
        self.tx_errs
            .with_guarded_label_values(&labels)
            .set(stats.txerrs as i64);
        self.tx_retries
            .with_guarded_label_values(&labels)
            .set(stats.txretries as i64);
        self.tx_idle
            .with_guarded_label_values(&labels)
            .set(stats.txidle);
        self.req_timeouts
            .with_guarded_label_values(&labels)
            .set(stats.req_timeouts as i64);
        self.rx
            .with_guarded_label_values(&labels)
            .set(stats.rx as i64);
        self.rx_bytes
        ...
        self.rx_errs
            .with_guarded_label_values(&labels)
            .set(stats.rxerrs as i64);
        self.rx_corriderrs
            .with_guarded_label_values(&labels)
            .set(stats.rxcorriderrs as i64);
        self.rx_partial
            .with_guarded_label_values(&labels)
            .set(stats.rxpartial as i64);
        self.rx_idle
            .with_guarded_label_values(&labels)
            .set(stats.rxidle);
        ...
        self.zbuf_grow
            .with_guarded_label_values(&labels)
            .set(stats.zbuf_grow as i64);
        self.buf_grow
            .with_guarded_label_values(&labels)
            .set(stats.buf_grow as i64);
