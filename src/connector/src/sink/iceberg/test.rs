...
use crate::sink::iceberg::{
    ...
    DEFAULT_COMPACTION_MAX_SNAPSHOTS_NUM, DEFAULT_SNAPSHOT_EXPIRATION_MAX_AGE_MILLIS,
    DEFAULT_SNAPSHOT_EXPIRATION_RETAIN_LAST, ENABLE_COMPACTION, ENABLE_SNAPSHOT_EXPIRATION,
