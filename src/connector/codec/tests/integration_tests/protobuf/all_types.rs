...
pub struct AllTypes {
    ...
    pub map_field: ::std::collections::HashMap<::prost::alloc::string::String, i32>,
    /// timestamp
    ...
    pub map_struct_field: ::std::collections::HashMap<
        ::prost::alloc::string::String,
        all_types::NestedMessage,
    >,
    #[prost(map = "int32, enumeration(all_types::EnumType)", tag = "30")]
    pub map_enum_field: ::std::collections::HashMap<i32, i32>,
    /// oneof field
