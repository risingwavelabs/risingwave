...
/// States for [`crate::executor_v2::LocalSimpleAggExecutor`], [`crate::executor::SimpleAggExecutor`]
...
/// Trait for [`crate::executor::SimpleAggExecutor`] and [`crate::executor::HashAggExecutor`], providing an
