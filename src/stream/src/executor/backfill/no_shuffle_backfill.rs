    ...
    S: StateStore,
{
    ...
    async fn execute_inner(mut self) {
        ...
        if to_backfill {
            ...
            let mut processed_snapshot_in_current_barrier = false;
            'backfill_loop: loop {
                            ...
                            Either::Left(msg) => {
                                match msg? {
                                    Message::Barrier(barrier) => {
                                        ...
                                        if !processed_snapshot_in_current_barrier {
                            ...
                            Either::Right(msg) => {
                                match msg? {
                                    ...
                                    Some(chunk) => {
                                        ...
                                        processed_snapshot_in_current_barrier = true;
                                    }
                                }
                            }
                        }
                ...
                assert!(processed_snapshot_in_current_barrier);
