...
pub struct StreamingMetrics {
    ...
    actor_scheduled_duration: LabelGuardedIntCounterVec,
    actor_scheduled_cnt: LabelGuardedIntCounterVec,
    actor_fast_poll_duration: LabelGuardedIntCounterVec,
    actor_fast_poll_cnt: LabelGuardedIntCounterVec,
    actor_slow_poll_duration: LabelGuardedIntCounterVec,
    actor_slow_poll_cnt: LabelGuardedIntCounterVec,
    actor_poll_duration: LabelGuardedIntCounterVec,
    actor_poll_cnt: LabelGuardedIntCounterVec,
    actor_idle_duration: LabelGuardedIntCounterVec,
    actor_idle_cnt: LabelGuardedIntCounterVec,
