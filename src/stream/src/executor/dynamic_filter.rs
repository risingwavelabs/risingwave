...
mod tests {
    ...
    async fn test_dynamic_filter_rhs_recovery_gt() -> StreamExecutorResult<()> {
        ...
        tx_l.push_barrier(
            EpochWithGap::new_without_offset(1).as_u64_for_test() * 2,
            false,
        );
        tx_r.push_barrier(
            EpochWithGap::new_without_offset(1).as_u64_for_test() * 2,
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(
            EpochWithGap::new_without_offset(1).as_u64_for_test() * 3,
            false,
        );
        tx_r.push_barrier(
            EpochWithGap::new_without_offset(1).as_u64_for_test() * 3,
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(
            EpochWithGap::new_without_offset(1).as_u64_for_test() * 4,
            false,
        );
        tx_r.push_barrier(
            EpochWithGap::new_without_offset(1).as_u64_for_test() * 4,
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(
            EpochWithGap::new_without_offset(1).as_u64_for_test() * 5,
            false,
        );
        tx_r.push_barrier(
            EpochWithGap::new_without_offset(1).as_u64_for_test() * 5,
    ...
    async fn test_dynamic_filter_greater_than() -> StreamExecutorResult<()> {
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(EpochWithGap::new_without_offset(3).as_u64_for_test(), false);
        tx_r.push_barrier(EpochWithGap::new_without_offset(3).as_u64_for_test(), false);
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(EpochWithGap::new_without_offset(4).as_u64_for_test(), false);
        tx_r.push_barrier(EpochWithGap::new_without_offset(4).as_u64_for_test(), false);
    ...
    async fn test_dynamic_filter_always_relax() -> StreamExecutorResult<()> {
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(EpochWithGap::new_without_offset(5).as_u64_for_test(), false);
        tx_r.push_barrier(EpochWithGap::new_without_offset(5).as_u64_for_test(), false);
        ...
        // Get the barrier
        dynamic_filter.next_unwrap_ready_barrier()?;
        tx_l.push_barrier(EpochWithGap::new_without_offset(6).as_u64_for_test(), false);
        tx_r.push_barrier(EpochWithGap::new_without_offset(6).as_u64_for_test(), false);
        // Get the barrier
        dynamic_filter.next_unwrap_ready_barrier()?;
