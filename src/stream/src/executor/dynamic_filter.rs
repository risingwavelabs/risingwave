...
mod tests {
    ...
    async fn test_dynamic_filter_rhs_recovery_gt() -> StreamExecutorResult<()> {
        ...
        tx_r.push_barrier(TestEpoch::new_without_offset(1).as_u64(), false);
        dynamic_filter.next_unwrap_ready_barrier()?;

        // push the 0th right chunk
        tx_r.push_chunk(chunk_r0);

        tx_l.push_barrier(TestEpoch::new_without_offset(1).as_u64() * 2, false);
        tx_r.push_barrier(TestEpoch::new_without_offset(1).as_u64() * 2, false);
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(TestEpoch::new_without_offset(1).as_u64() * 3, false);
        tx_r.push_barrier(TestEpoch::new_without_offset(1).as_u64() * 3, false);
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(TestEpoch::new_without_offset(1).as_u64() * 4, false);
        tx_r.push_barrier(TestEpoch::new_without_offset(1).as_u64() * 4, false);
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(TestEpoch::new_without_offset(1).as_u64() * 5, false);
        tx_r.push_barrier(TestEpoch::new_without_offset(1).as_u64() * 5, false);
    ...
    async fn test_dynamic_filter_greater_than() -> StreamExecutorResult<()> {
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(TestEpoch::new_without_offset(2).as_u64(), false);
        tx_r.push_barrier(TestEpoch::new_without_offset(2).as_u64(), false);
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(TestEpoch::new_without_offset(3).as_u64(), false);
        tx_r.push_barrier(TestEpoch::new_without_offset(3).as_u64(), false);
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(TestEpoch::new_without_offset(4).as_u64(), false);
        tx_r.push_barrier(TestEpoch::new_without_offset(4).as_u64(), false);
    ...
    async fn test_dynamic_filter_always_relax() -> StreamExecutorResult<()> {
        ...
        // push the init barrier for left and right
        tx_l.push_barrier(TestEpoch::new_without_offset(5).as_u64(), false);
        tx_r.push_barrier(TestEpoch::new_without_offset(5).as_u64(), false);
        ...
        // Get the barrier
        dynamic_filter.next_unwrap_ready_barrier()?;
        tx_l.push_barrier(TestEpoch::new_without_offset(6).as_u64(), false);
        tx_r.push_barrier(TestEpoch::new_without_offset(6).as_u64(), false);
        // Get the barrier
        dynamic_filter.next_unwrap_ready_barrier()?;
