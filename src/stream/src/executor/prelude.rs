...
pub use crate::executor::{
    ...
    MessageStreamItem, Mutation, ResolvePhase, StreamKey, StreamKeyDataTypes, StreamKeyRef,
    Watermark, expect_first_barrier, expect_first_barrier_from_aligned_stream,
};
