...
impl ExecutorBuilder for CompactionResolverExecutorBuilder {
    ...
    async fn new_boxed_executor(
        ...
        // Build the same `IcebergConfig` the writer builds from its `sink_desc`, used to load the
        // iceberg table / `FileIO` for the deletion-vector diff and data-file scans.
