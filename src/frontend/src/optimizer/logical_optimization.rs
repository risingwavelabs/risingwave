...
static TABLE_FUNCTION_CONVERT: LazyLock<OptimizationStage> = LazyLock::new(|| {
    OptimizationStage::new(
        ...
        vec![
            ...
            // Apply internal get fragment vnodes rule next
            TableFunctionToInternalGetFragmentVnodesRule::create(),
...
static TABLE_FUNCTION_TO_INTERNAL_GET_FRAGMENT_VNODES: LazyLock<OptimizationStage> =
    LazyLock::new(|| {
        OptimizationStage::new(
            "Table Function To Internal Get Fragment Vnodes",
            vec![TableFunctionToInternalGetFragmentVnodesRule::create()],
            ApplyOrder::TopDown,
        )
    });
...
impl LogicalOptimizer {
    ...
    pub fn gen_optimized_logical_plan_for_batch(
        ...
        plan = plan.optimize_by_rules(&TABLE_FUNCTION_TO_INTERNAL_GET_FRAGMENT_VNODES)?;
