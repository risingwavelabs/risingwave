...
impl ToString for PlanNodeType {
    fn to_string(&self) -> String {
        // return the name of all arms of enum
        match self {
            PlanNodeType::LogicalAgg => "LogicalAgg".to_string(),
            PlanNodeType::LogicalApply => "LogicalApply".to_string(),
            PlanNodeType::LogicalFilter => "LogicalFilter".to_string(),
            PlanNodeType::LogicalProject => "LogicalProject".to_string(),
            PlanNodeType::LogicalScan => "LogicalScan".to_string(),
            PlanNodeType::LogicalSource => "LogicalSource".to_string(),
            PlanNodeType::LogicalInsert => "LogicalInsert".to_string(),
            PlanNodeType::LogicalDelete => "LogicalDelete".to_string(),
            PlanNodeType::LogicalUpdate => "LogicalUpdate".to_string(),
            PlanNodeType::LogicalJoin => "LogicalJoin".to_string(),
            PlanNodeType::LogicalValues => "LogicalValues".to_string(),
            PlanNodeType::LogicalLimit => "LogicalLimit".to_string(),
            PlanNodeType::LogicalTopN => "LogicalTopN".to_string(),
            PlanNodeType::LogicalHopWindow => "LogicalHopWindow".to_string(),
            PlanNodeType::LogicalTableFunction => "LogicalTableFunction".to_string(),
            PlanNodeType::LogicalMultiJoin => "LogicalMultiJoin".to_string(),
            PlanNodeType::LogicalExpand => "LogicalExpand".to_string(),
            PlanNodeType::LogicalProjectSet => "LogicalProjectSet".to_string(),
            PlanNodeType::LogicalUnion => "LogicalUnion".to_string(),
            PlanNodeType::BatchSimpleAgg => "BatchSimpleAgg".to_string(),
            PlanNodeType::BatchHashAgg => "BatchHashAgg".to_string(),
            PlanNodeType::BatchProject => "BatchProject".to_string(),
            PlanNodeType::BatchFilter => "BatchFilter".to_string(),
            PlanNodeType::BatchInsert => "BatchInsert".to_string(),
            PlanNodeType::BatchDelete => "BatchDelete".to_string(),
            PlanNodeType::BatchUpdate => "BatchUpdate".to_string(),
            PlanNodeType::BatchSeqScan => "BatchSeqScan".to_string(),
            PlanNodeType::BatchHashJoin => "BatchHashJoin".to_string(),
            PlanNodeType::BatchNestedLoopJoin => "BatchNestedLoopJoin".to_string(),
            PlanNodeType::BatchValues => "BatchValues".to_string(),
            PlanNodeType::BatchSort => "BatchSort".to_string(),
            PlanNodeType::BatchExchange => "BatchExchange".to_string(),
            PlanNodeType::BatchLimit => "BatchLimit".to_string(),
            PlanNodeType::BatchTopN => "BatchTopN".to_string(),
            PlanNodeType::BatchHopWindow => "BatchHopWindow".to_string(),
            PlanNodeType::BatchTableFunction => "BatchTableFunction".to_string(),
            PlanNodeType::BatchExpand => "BatchExpand".to_string(),
            PlanNodeType::BatchLookupJoin => "BatchLookupJoin".to_string(),
            PlanNodeType::BatchProjectSet => "BatchProjectSet".to_string(),
            PlanNodeType::BatchUnion => "BatchUnion".to_string(),
            PlanNodeType::StreamProject => "StreamProject".to_string(),
            PlanNodeType::StreamFilter => "StreamFilter".to_string(),
            PlanNodeType::StreamTableScan => "StreamTableScan".to_string(),
            PlanNodeType::StreamSink => "StreamSink".to_string(),
            PlanNodeType::StreamSource => "StreamSource".to_string(),
            PlanNodeType::StreamHashJoin => "StreamHashJoin".to_string(),
            PlanNodeType::StreamExchange => "StreamExchange".to_string(),
            PlanNodeType::StreamHashAgg => "StreamHashAgg".to_string(),
            PlanNodeType::StreamLocalSimpleAgg => "StreamLocalSimpleAgg".to_string(),
            PlanNodeType::StreamGlobalSimpleAgg => "StreamGlobalSimpleAgg".to_string(),
            PlanNodeType::StreamMaterialize => "StreamMaterialize".to_string(),
            PlanNodeType::StreamTopN => "StreamTopN".to_string(),
            PlanNodeType::StreamHopWindow => "StreamHopWindow".to_string(),
            PlanNodeType::StreamDeltaJoin => "StreamDeltaJoin".to_string(),
            PlanNodeType::StreamIndexScan => "StreamIndexScan".to_string(),
            PlanNodeType::StreamExpand => "StreamExpand".to_string(),
            PlanNodeType::StreamDynamicFilter => "StreamDynamicFilter".to_string(),
            PlanNodeType::StreamProjectSet => "StreamProjectSet".to_string(),
            PlanNodeType::StreamGroupTopN => "StreamGroupTopN".to_string(),
        }
    }
}
