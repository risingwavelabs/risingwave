...
pub static RW_MATERIALIZED_VIEWS: LazyLock<BuiltinTable> = LazyLock::new(|| BuiltinTable {
    name: "rw_materialized_views",
...
impl SysCatalogReaderImpl {
    pub fn read_rw_mview_info(&self) -> Result<Vec<OwnedRow>> {
