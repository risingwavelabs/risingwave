    ...
    return [
        outer_panels.row_collapsed(
            ...
            [
                panels.timeseries_count(
                    "SSTable Count",
                    "The number of SSTables at each level and all levels in total",
                    [
                        panels.target(
                        ...
                        panels.target(
                            f"sum({metric('storage_level_sst_num')}) by (instance)",
                            "All Levels In Total",
                        ),
                    ],
                ),
                panels.timeseries_kilobytes(
                    "SSTable Size(KB)",
                    "The size(KB) of SSTables at each level and all levels in total",
                    [
                        panels.target(
                        ...
                        panels.target(
                            f"sum({metric('storage_level_total_file_size')}) by (instance)",
                            "All Levels In Total"
                        ),
                    ],
                ),
