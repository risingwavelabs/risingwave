...
sqllogictest -p 4566 -d dev './e2e_test/subscription/check_sql_statement.slt' --junit "batch-${profile}"
"$HOME"/.local/bin/poetry run python ./e2e_test/subscription/main.py
