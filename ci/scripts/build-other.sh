...
tar cf java-binding-integration-test.tar bin java/java-binding-integration-test/target/dependency java/java-binding-integration-test/target/classes
...
buildkite-agent artifact upload ./java-binding-integration-test.tar
