...
cp src/udf/java/target/risingwave-udf-1.0-SNAPSHOT-jar-with-dependencies.jar ./risingwave-udf-examples.jar
buildkite-agent artifact upload ./risingwave-connector.tar.gz
buildkite-agent artifact upload ./risingwave-udf-examples.jar
