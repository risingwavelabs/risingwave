...
./risedev slt -p 4566 -d dev ./e2e_test/ch-benchmark/create_sources.slt.part
./risedev slt -p 4566 -d dev ./e2e_test/ch-benchmark/q13.slt.part
./risedev slt -p 4566 -d dev ./e2e_test/ch-benchmark/drop_sources.slt.part
