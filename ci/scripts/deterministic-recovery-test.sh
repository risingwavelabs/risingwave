...
risingwave_meta::barrier::schedule=trace"
...
MADSIM_TEST_SEED=8 ./risingwave_simulation \
--kill \
--kill-rate=${KILL_RATE} \
--background-ddl-rate=${BACKGROUND_DDL_RATE} \
${USE_ARRANGEMENT_BACKFILL:-} \
./e2e_test/batch/\*\*/\*.slt 2> $LOGDIR/recovery-batch-8.log && rm $LOGDIR/recovery-batch-8.log
