...
timeout 5m sqllogictest -p 4566 -d dev -u risingwave './e2e_test/streaming/**/*.slt'
...
~/cargo-make/makers ci-start ci-3cn-1fe
timeout 3m sqllogictest -p 4566 -d dev -u risingwave './e2e_test/streaming_delta_join/**/*.slt'
...
~/cargo-make/makers ci-start ci-3cn-1fe
timeout 2m sqllogictest -p 4566 -d dev -u risingwave './e2e_test/ddl/**/*.slt'
timeout 2m sqllogictest -p 4566 -d dev -u risingwave './e2e_test/batch/**/*.slt'
timeout 2m sqllogictest -p 4566 -d dev -u risingwave './e2e_test/database/prepare.slt'
timeout 2m sqllogictest -p 4566 -d test -u risingwave './e2e_test/database/test.slt'
