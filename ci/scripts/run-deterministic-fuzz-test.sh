...
set +e
seq 10 | parallel 'MADSIM_TEST_SEED={} ./risingwave_simulation --sqlsmith 10 --enable eowc ./src/tests/sqlsmith/tests/testdata 2> $LOGDIR/fuzzing-{}.log && rm $LOGDIR/fuzzing-{}.log'
set -e
