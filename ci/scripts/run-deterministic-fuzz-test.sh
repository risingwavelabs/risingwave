...
set +e
seq 7 | parallel 'MADSIM_TEST_SEED={} ./risingwave_simulation --sqlsmith 100 --enable eowc ./src/tests/sqlsmith/tests/testdata 2> $LOGDIR/fuzzing-{}.log && rm $LOGDIR/fuzzing-{}.log'
set -e
