...
**Ubuntu**
```
wget https://github.com/risingwavelabs/risingwave/releases/download/v1.5.1/risingwave-v1.5.1-x86_64-unknown-linux-all-in-one.tar.gz
tar xvf risingwave-v1.5.1-x86_64-unknown-linux-all-in-one.tar.gz
./risingwave playground
```
