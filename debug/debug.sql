...
FROM
    ...
    m9 AS t_27
WHERE
    CASE WHEN true THEN FLOAT '0' WHEN false THEN FLOAT '0' WHEN false THEN FLOAT '51613815.26926697' WHEN true THEN CASE WHEN REAL '1' = FLOAT '634434057.7055044' THEN FLOAT '1691970914.2593095' * (
    (
    CASE WHEN true THEN REAL '1' WHEN t_22.col_1 > 206609731.5285713 THEN t_16.col_3 WHEN true THEN REAL '1' WHEN false THEN t_16.col_3 WHEN false THEN t_26.col_1 WHEN false THEN t_16.col_3 ELSE REAL '2147483647' END * t_26.col_1
    ) / (- REAL '1')
