...
import com.risingwave.connector.api.*;
...
public class FlinkDynamicAdapterUtil {
    ...
    public static FlinkSinkFinderAndSinkFactory discoverFlinkSinkFinderAndSinkFactory(
            String connectorName) {
        if (connectorName.equals("http-sink")) {
            return new HttpFlinkSinkFinderAndSinkFactory();
        }
