...
public class SinkStreamObserverTest {
  ...
  public ConnectorServiceProto.SinkParam fileSinkParam =
      ConnectorServiceProto.SinkParam.newBuilder()
          ...
          .putAllProperties(Map.of("output.path", "/tmp/rw-connector", "connector", "file"))
          .build();
        ...
        ConnectorServiceProto.SinkWriterStreamRequest.newBuilder()
            .setWriteBatch(
                ConnectorServiceProto.SinkWriterStreamRequest.WriteBatch.newBuilder()
                    ...
                    .setBatchId(1)
                    .setJsonPayload(
                        ConnectorServiceProto.SinkWriterStreamRequest.WriteBatch.JsonPayload
                            .newBuilder()
                            .addRowOps(
                                ConnectorServiceProto.SinkWriterStreamRequest.WriteBatch.JsonPayload
                                    .RowOp.newBuilder()
                                    .setOpType(Op.INSERT)
                                    .setLine("{\"id\": 1, \"name\": \"test\"}")
                                    .build()))
                    .build())
            .build();
