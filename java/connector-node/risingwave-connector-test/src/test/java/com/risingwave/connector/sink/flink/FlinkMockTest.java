...
public class FlinkMockTest {
  ...
  private TableSchema getTableSchema() {
    return new TableSchema(
        Lists.newArrayList("id", "name", "v_date", "v_time", "v_timestamp", "v_timestamptz"),
        Lists.newArrayList(
            ...
            Data.DataType.newBuilder().setTypeName(Data.DataType.TypeName.TIMESTAMP).build(),
            Data.DataType.newBuilder().setTypeName(Data.DataType.TypeName.TIMESTAMPTZ).build()),
  ...
  public void testSinkWriteV1() {
    ...
    assertEquals(
        rowData1.getTimestamp(4, 0).toLocalDateTime(), LocalDateTime.of(1970, 1, 1, 0, 0, 0, 1000));
    assertEquals(
    ...
    assertEquals(
        rowData2.getTimestamp(4, 0).toLocalDateTime(), LocalDateTime.of(1970, 1, 1, 0, 0, 0, 1000));
    assertEquals(
    ...
    assertEquals(
        rowData3.getTimestamp(4, 0).toLocalDateTime(), LocalDateTime.of(1970, 1, 1, 0, 0, 0, 1000));
    assertEquals(
    ...
    assertEquals(
        rowData4.getTimestamp(4, 0).toLocalDateTime(), LocalDateTime.of(1970, 1, 1, 0, 0, 0, 1000));
