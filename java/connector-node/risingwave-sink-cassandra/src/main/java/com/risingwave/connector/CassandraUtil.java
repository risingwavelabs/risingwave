...
public class CassandraUtil {
    ...
    switch (dataType.getTypeName()) {
      ...
      case TIMESTAMP:
        throw Status.INVALID_ARGUMENT
            .withDescription("cassandra does not have a type corresponding to naive timestamp")
            .asRuntimeException();
      case TIMESTAMPTZ:
  ...
  public static void checkSchema(
      List<ColumnDesc> columnDescs, Map<CqlIdentifier, ColumnMetadata> cassandraColumnDescMap) {
