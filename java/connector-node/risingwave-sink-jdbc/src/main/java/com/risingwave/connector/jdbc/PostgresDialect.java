...
public class PostgresDialect implements JdbcDialect {
  ...
  public Optional<String> getUpsertStatement(
      SchemaTableName schemaTableName, List<String> fieldNames, List<String> primaryKeyFields) {
    String pkColumns =
        primaryKeyFields.stream().map(this::quoteIdentifier).collect(Collectors.joining(", "));
    String updateClause =
        fieldNames.stream()
