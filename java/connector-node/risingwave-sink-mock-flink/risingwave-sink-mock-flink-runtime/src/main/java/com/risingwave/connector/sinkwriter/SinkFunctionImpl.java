...
/*
 * The SinkFunction-type sink will invoke this class to write RW data to the downstream. need test.
 */
public class SinkFunctionImpl implements SinkWriterAdapter {
