...
import com.risingwave.connector.api.FlinkDynamicUtil;
 ...
 */
public class CatalogSchemaValidate {
     ...
     */
    public CatalogSchemaValidate(TableSchema tableSchema, FlinkDynamicAdapterConfig config) {
    ...
    private static boolean checkType(Data.DataType dataType, DataType flinkType) {
        switch (dataType.getTypeName()) {
            ...
            default:
                return FlinkDynamicUtil.getCorrespondingFlinkType(dataType).equals(flinkType);
        }
    }
}
