 ...
 *
 * <p>Normally, MySQL uses "Text protocol" to return a value. When set `useCursorFetch=true`,
...
public interface MySqlFieldReader {
    ...
    Object readField(ResultSet rs, int fieldNo, Column actualColumn, Table actualTable)
            throws SQLException;
}
