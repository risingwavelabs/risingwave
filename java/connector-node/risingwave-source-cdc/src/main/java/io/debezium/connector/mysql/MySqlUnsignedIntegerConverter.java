...
/**
 * A converter API for MySQL Unsigned Integer types. It intends to convert any integer type value
 * from binlog into the correct representation of unsigned numeric MySQL binlog stores unsigned
 * numeric into this format: (insertion value - Maximum data type boundary - 1), therefore to
 * calculate the correct unsigned numeric representation we will inverse the original calculation by
 * applying this calculation: (insertion value + Maximum data type boundary + 1). Please see DBZ-228
 * for more info
 *
 * @author Omar Al-Safi
 */
public class MySqlUnsignedIntegerConverter {
    /**
     * Maximum values for Unsigned Integer Types. Needed in order to calculate actual value of an
     * Unsigned Integer Types from binlog value. Reference to {@see
    ...
    /**
     * Convert original value insertion of type 'TINYINT' into the correct TINYINT UNSIGNED
     * representation Note: Unsigned TINYINT (8-bit) is represented in 'Short' 16-bit data type.
     * Reference:
    ...
    /**
     * Convert original value insertion of type 'SMALLINT' into the correct SMALLINT UNSIGNED
     * representation Note: Unsigned SMALLINT (16-bit) is represented in 'Integer' 32-bit data type.
     * Reference:
     * https://kafka.apache.org/0102/javadoc/org/apache/kafka/connect/data/Schema.Type.html
     *
    ...
    /**
     * Convert original value insertion of type 'MEDIUMINT' into the correct MEDIUMINT UNSIGNED
     * representation Note: Unsigned MEDIUMINT (24-bit) is represented in 'Integer' 32-bit data type
     * since the MAX value of Unsigned MEDIUMINT 16777215 < Max value of Integer 2147483647
     *
     * @param originalNumber {@link Integer} the original insertion value
     * @return {@link Integer} the correct representation of the original insertion value
     */
     ...
     * Note: Unsigned INT (32-bit) is represented in 'Long' 64-bit data type. Reference:
     * https://kafka.apache.org/0102/javadoc/org/apache/kafka/connect/data/Schema.Type.html
     *
    ...
    /**
     * Convert original value insertion of type 'BIGINT' into the correct BIGINT UNSIGNED
     * representation Note: Unsigned BIGINT (64-bit) is represented in 'BigDecimal' data type.
     * Reference:
     * https://kafka.apache.org/0102/javadoc/org/apache/kafka/connect/data/Schema.Type.html
     *
