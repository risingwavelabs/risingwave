...
public class TransactionPayloadDeserializer extends TransactionPayloadEventDataDeserializer {
    ...
    public TransactionPayloadDeserializer(
            ...
            EventProcessingFailureHandlingMode eventDeserializationFailureHandlingMode) {
    ...
    public TransactionPayloadEventData deserialize(ByteArrayInputStream inputStream)
        ...
        transactionPayloadEventDeserializer.setEventDataDeserializer(
        ...
        while (internalEvent != null) {
            ...
            if (internalEvent.getHeader().getEventType() == EventType.TABLE_MAP
