 ...
 *
 * <p>This is an improvement ove {@link com.github.shyiko.mysql.binlog.GtidSet} that is immutable,
...
public class MySqlGtidSet implements GtidSet {
    ...
    public static Pattern gtidDelimiter = Pattern.compile(":");
    ...
    public boolean contains(String gtid) {
        String[] split = gtidDelimiter.split(gtid);
