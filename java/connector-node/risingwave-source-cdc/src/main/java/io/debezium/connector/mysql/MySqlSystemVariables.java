...
/**
 * Custom class for MySQL {@link SystemVariables}, which defines MySQL scopes and constants of used
 * variable names.
 *
...
public class MySqlSystemVariables extends SystemVariables {
    ...
    /**
     * The system variable name to see if the MySQL tables are stored and looked-up in case
     * sensitive way. See
