...
public class MySqlCloudEventsMaker extends CloudEventsMaker {
    ...
    public String ceId() {
        return "name:"
                ...
                + ";file:"
                + recordParser.getMetadata(MySqlRecordParser.BINLOG_FILENAME_OFFSET_KEY)
                + ";pos:"
                + recordParser.getMetadata(MySqlRecordParser.BINLOG_POSITION_OFFSET_KEY);
    }
}
