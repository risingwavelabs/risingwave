...
public interface GtidSet {
    ...
    /**
     * Obtain a copy of this {@link GtidSet} except with only the GTID ranges match the specified
     * predicate.
     *
    ...
    /**
     * Determine whether the GTIDs represented by this object are contained completely within the
     * supplied set.
     *
    ...
    /**
     * Obtain a copy of this {@link GtidSet} except overwritten with all the GTID ranges in the
