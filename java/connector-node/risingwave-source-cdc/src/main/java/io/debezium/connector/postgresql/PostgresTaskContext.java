...
public class PostgresTaskContext extends CdcSourceTaskContext {
    ...
    Long getSlotXmin(PostgresConnection connection) throws SQLException {
        ...
        if (this.refreshXmin.hasElapsed() || lastXmin == null) {
            ...
            LOGGER.trace("reusing last xmin value of {}", lastXmin);
        }
    ...
    protected ReplicationConnection createReplicationConnection(PostgresConnection jdbcConnection)
            throws SQLException {
        ...
        ReplicationConnection replicationConnection =
                ReplicationConnection.builder(config())
                        ...
                        .build();
        return new GuardedReplicationConnection(replicationConnection);
    }
}
