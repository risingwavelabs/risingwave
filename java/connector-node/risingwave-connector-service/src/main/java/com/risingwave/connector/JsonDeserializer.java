    ...
    if (value instanceof Integer) {
      ...
      if (d % 1.0 != 0.0) {
        ...
        throw io.grpc.Status.INVALID_ARGUMENT
            .withDescription("unable to cast into long from non-integer double value: " + d)
            .asRuntimeException();
      }
      ...
      if (f % 1.0 != 0.0) {
        ...
        throw io.grpc.Status.INVALID_ARGUMENT
            .withDescription("unable to cast into long from non-integer float value: " + f)
            .asRuntimeException();
      }
  ...
  private static Object validateJsonDataTypes(Data.DataType.TypeName typeName, Object value) {
    ...
    switch (typeName) {
      ...
      case TIMESTAMPTZ:
        if (!(value instanceof String)) {
          throw io.grpc.Status.INVALID_ARGUMENT
              .withDescription("Expected timestamptz in string, got " + value.getClass())
              .asRuntimeException();
        }
