  ...
  public void all_types() throws Exception {
    ...
    var c10 =
        new IntervalMonthDayNanoVector(
            "", FieldType.nullable(MinorType.INTERVALMONTHDAYNANO.getType()), allocator);
    c10.allocateNew(2);
    ...
    var c14 = new StructVector("", allocator, FieldType.nullable(ArrowType.Struct.INSTANCE), null);
    c14.allocateNew();
    ...
    var input =
        VectorSchemaRoot.of(c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14);
