...
class AstBuilder extends SqlBaseBaseVisitor<SqlNode> {
  ...
  //        getParserPos(context), false, notExists, (SqlIdentifier) tableName, tableElements,
  // null);
  //  }
  //
  //
  ...
  //
  //  @Override
  //  public SqlNode visitValueExpressionDefault(SqlBaseParser.ValueExpressionDefaultContext
  // context) {
  ...
  //    return new SqlIdentifier(context.getText().toLowerCase(Locale.ENGLISH),
  // getParserPos(context));
  //  }
  //
  //  @Override
  ...
  //  }
  //
  //  private static SqlTypeName convertToType(SqlIdentifier ident) {
