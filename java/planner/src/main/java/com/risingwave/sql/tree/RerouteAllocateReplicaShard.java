...
public class RerouteAllocateReplicaShard<T> extends RerouteOption {
  ...
  public <U> RerouteAllocateReplicaShard<U> map(Function<? super T, ? extends U> mapper) {
    return new RerouteAllocateReplicaShard<>(mapper.apply(shardId), mapper.apply(nodeIdOrName));
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(nodeIdOrName, that.nodeIdOrName) && Objects.equals(shardId, that.shardId);
  }
  ...
  public String toString() {
    return "RerouteAllocateReplicaShard{" + "shardId=" + shardId + ", nodeId=" + nodeIdOrName + '}';
  }
